...
// 
const URLImage = ( images: any, image: any , shapeProps: any, isSelected: any, onSelect: any, onChange: any ) => {
  const [img] = useImage(image.src, 'Anonymous');

  const shapeRef: any | undefined = useRef();
  const trRef: any | undefined = useRef();
